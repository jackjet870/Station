    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (process == null)
            {
                ...
                Application.Run(Index.GetInstance());
            }
            else
            {
        ...
        private static void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            Logs.LogError(fileName + " : " + assName + "." + typeName + "." + methodName + "(" + lineNo + "行" + colNo + "列)", str);
        ...
        {
            string path = System.Environment.GetFolderPath(Environment.SpecialFolder.Programs) + @"\欧客科技";
